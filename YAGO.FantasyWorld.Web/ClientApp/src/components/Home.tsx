...
const Home = () => (
  <div>
    ...
    <ul>
      <li><a href='https://get.asp.net/'>ASP.NET Core</a> и <a href='https://msdn.microsoft.com/en-us/library/67ef8sbd.aspx'>C#</a> для кроссплатформенного серверного кода</li>
      <li><a href='https://facebook.github.io/react/'>React</a> и <a href='https://redux.js.org/'>Redux</a> для клиентского кода</li>
      <li><a href='http://getbootstrap.com/'>Bootstrap</a> для макета и стиля</li>
    </ul>
